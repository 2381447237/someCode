       ...
       // 将VirtualLayoutManager绑定到recyclerView
        ...
        for(int i=0;i<100;i++){
           Content c=new Content();
            c.setTv("第"+i+"行");
            c.setIv(R.drawable.tangyan);
           // c.setIv(R.mipmap.ic_launcher);
            data.add(c);
        }
        ...
        Adapter_linearLayout  = new MyAdapter(this, linearLayoutHelper, 4, data) {
        ...
        Adapter_StickyLayout = new MyAdapter(this, stickyLayoutHelper,1, data) {
            // 设置需要展示的数据总数,此处设置是1
...
//        }
        ...
        Adapter_ScrollFixLayout  = new MyAdapter(this, scrollFixLayoutHelper,1, data) {
            // 设置需要展示的数据总数,此处设置是1
        ...
        Adapter_GridLayout  = new MyAdapter(this, gridLayoutHelper,36, data) {
...
//        }
        ...
        Adapter_FixLayout  = new MyAdapter(this, fixLayoutHelper,1, data) {
            // 设置需要展示的数据总数,此处设置是1
...
//        }
        ...
        Adapter_FloatLayout = new MyAdapter(this, floatLayoutHelper,1, data) {
            // 设置需要展示的数据总数,此处设置是1
        ...
        Adapter_ColumnLayout = new MyAdapter(this, columnLayoutHelper,3, data) {
            // 设置需要展示的数据总数,此处设置是3
        ...
        Adapter_SingleLayout = new MyAdapter(this, singleLayoutHelper,1, data) {
            // 设置需要展示的数据总数,此处设置是1
        ...
        Adapter_onePlusNLayout = new MyAdapter(this, onePlusNLayoutHelper,5, data) {
        ...
        Adapter_StaggeredGridLayout = new MyAdapter(this, staggeredGridLayoutHelper,20, data) {
            // 设置需要展示的数据总数,此处设置是20
...
//        });
    ...
    public void onItemClick(View view, int postion) {
        ...
        Toast.makeText(this, data.get(postion).getTv(), Toast.LENGTH_SHORT).show();
    }
