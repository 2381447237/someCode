...
public class CirclePerecentView extends View{
	...
	public CirclePerecentView(Context context) {
		this(context,null);
	}
	public CirclePerecentView(Context context, AttributeSet attrs) {
    ...
    //外部设置百分比数
      public void setPercent(int percent){
    	  if(percent>100){
    		  try {
				throw new IllegalAccessException("percent must less than 100!");
