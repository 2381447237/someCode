package com.example.materialrefreshlayout.view;
...
public class SunFaceView extends View {
    ...
    private static final int DEFAULT_SUN_RADIUS = 12;//Ì«ÑôµÄ°ë¾¶
    private static final int DEFAULT_EYES_RADIUS = 2;//ÑÛ¾¦µÄ°ë¾¶

    private int mHeight, mWidth;
    private Paint mCirclePaint;//»­Ô²µÄ»­±Ê
